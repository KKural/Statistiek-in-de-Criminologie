      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "2" = "✅ **Juist!** Optie 2 (0.9%) is correct. Met N(45,9) anesthesie en N(100,18) letaal voor 92% effectiviteit berekenen we: **Stap 1:** Z₉₂% = 1.405 → X = 1.405×9+45 = 57.65 mg **Stap 2:** Z = (57.65-100)/18 = -2.36 → P(Z ≤ -2.36) = 0.0091 = **0.9%**. Dit is een realistische mortaliteit voor anesthesie bij deze dosering. [Z-tabel referentie](https://www.belfactorij.nl/voorinloggen/kansverdelingen/Normaal.htm)",
