    ...
    "",
    {
      testEqual(
        ...
        function(env) {
          ...
          results$gemiddelde_x <- check_numeric("gemiddelde_x", exp_gemiddelde_x, 0.0051, 2)
          results$gemiddelde_y <- check_numeric("gemiddelde_y", exp_gemiddelde_y, 0.000051, 4)
          results$SSx <- check_numeric("SSx", exp_SSx, 0.0501, 1)
          results$SSy <- check_numeric("SSy", exp_SSy, 0.000051, 4)
          results$SSxy <- check_numeric("SSxy", exp_SSxy, 0.0051, 2)
          results$variantie_x <- check_numeric("variantie_x", exp_variantie_x, 0.0501, 1)
          results$variantie_y <- check_numeric("variantie_y", exp_variantie_y, 0.000051, 4)
          results$sd_x <- check_numeric("sd_x", exp_sd_x, 0.000051, 4)
          results$sd_y <- check_numeric("sd_y", exp_sd_y, 0.000051, 4)
          results$covariantie <- check_numeric("covariantie", exp_covariantie, 0.000051, 4)
          results$pearson_r <- check_numeric("pearson_r", exp_r, 0.000051, 4)
