      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "2" = "**Bevestiging:** Correct. Deze uitspraak is fout: Kendall's tau kan nooit gelijk zijn aan 2 of -2; de waarde blijft steeds binnen het interval [-1, 1]. <a href='https://www.statisticshowto.com/kendalls-tau/' target='_blank' rel='noopener noreferrer'>Lees meer</a>\n\n**Denkregel:** Kendall's tau vergelijkt concordante en discordante rangparen en is door normalisatie begrensd tussen -1 en +1.\n\n**Transferstap:** Voorspel het teken van tau voor twee ranglijsten van buurtoverlast die grotendeels tegengesteld geordend zijn en toets je voorspelde waarde aan [-1,+1].",
