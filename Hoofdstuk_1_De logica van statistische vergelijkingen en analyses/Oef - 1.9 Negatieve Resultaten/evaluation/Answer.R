      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "3" = "❌ Niet de beste keuze. Beginnende onderzoekers aanmoedigen en realistische verwachtingen scheppen kan een nuttig educatief neveneffect zijn. De belangrijkste wetenschappelijke reden is echter dat negatieve resultaten publicatiebias tegengaan en het totale bewijs compleet houden.",
          ...
          likely_reasons <- list(
            ...
            "3" = "je herkende terecht dat openheid over negatieve resultaten beginnende onderzoekers kan helpen; dat is echter een educatief neveneffect en niet het centrale wetenschappelijke argument.",
