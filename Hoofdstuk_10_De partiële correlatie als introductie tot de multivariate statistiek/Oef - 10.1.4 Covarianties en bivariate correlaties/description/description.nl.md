...
- `SCP_XY = 57/7`, `SCP_XZ = 60/7`, `SCP_YZ = 45/7`
- `SS_X = 202/7`, `SS_Y = 76/7`, `SS_Z = 96/7`
- `n − 1 = 6`

Bereken de covarianties en correlaties met de exacte breuken. Behoud de volledige precisie en rond alleen de zes gevraagde eindresultaten af op vier decimalen.
