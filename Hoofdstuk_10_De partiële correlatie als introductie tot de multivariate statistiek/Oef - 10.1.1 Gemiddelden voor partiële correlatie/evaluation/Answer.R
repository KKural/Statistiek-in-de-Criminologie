    ...
    "",
    {
      testEqual(
        ...
        function(env) {
          ...
          assign("split_results_10_1_1", results, envir = globalenv())
          all(vapply(results, function(item) isTRUE(item$ok), logical(1)))
        },
        TRUE,
        comparator = function(generated, expected, ...) {
          results <- get("split_results_10_1_1", envir = globalenv())
          labels <- c(
            X_bar = "gemiddelde X",
            Y_bar = "gemiddelde Y",
            Z_bar = "gemiddelde Z"
          ...
          diagnoses <- c(
            X_bar = "Je hebt mogelijk door n − 1 gedeeld of de X-kolom onvolledig opgeteld.",
            Y_bar = "Je hebt mogelijk een X-waarde in de Y-som gebruikt of door de verkeerde n gedeeld.",
            Z_bar = "Je hebt mogelijk een leeftijd overgeslagen of al vóór de deling afgerond."
          )
          choice_fields <- character()
          ...
          if (isTRUE(generated)) {
            ...
            message <- paste0(
              ...
              "\n\n**Denkregel:** Een gemiddelde gebruikt de som van precies de zeven waarden en n = 7; in deze reeks wordt het resultaat daarna op vier decimalen vastgezet.",
              "\n\n**Transferstap:** Bewaar bij een volgende partiële-correlatieberekening de ongeronde gemiddelden voor de afwijkingen en rond alleen de gerapporteerde eindwaarden af."
            )
          } else {
            ...
            message <- paste0(
              ...
              "\n\n**Denkregel:** Een gemiddelde gebruikt de som van precies de zeven waarden en n = 7; in deze reeks wordt het resultaat daarna op vier decimalen vastgezet.",
              "\n\n**Volgende stap:** Schrijf de zeven waarden van het eerste fout gemelde gemiddelde opnieuw onder elkaar, controleer de som en deel door zeven voordat je afrondt.",
