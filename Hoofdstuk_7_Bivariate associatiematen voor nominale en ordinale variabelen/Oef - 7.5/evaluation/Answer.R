      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "2" = "Correct. Deze uitspraak is fout: Kendall's tau kan nooit gelijk zijn aan 2 of -2; de waarde blijft steeds binnen het interval [-1, 1]. [Lees meer](https://www.statisticshowto.com/kendalls-tau/)",
            ...
            "4" = "Deze uitspraak is niet fout. Kendall's tau meet de overeenkomst tussen rangorden van twee variabelen. [Lees meer over ordinale correlaties](https://www.statisticshowto.com/kendalls-tau/)"
          )
