...
> **Praktische noot:** In deze oefening hoeven studenten de **p-waarde niet handmatig te berekenen**. De beslissing over significantie gebeurt via de klassieke regel: vergelijk je berekende **F** met **Fkrit** uit een **E-tabel** bij `alpha = 0.05`, met `df_between = k - 1` als teller-vrijheidsgraden en `df_within = N - k` als noemer-vrijheidsgraden. Een bruikbare E-tabel vind je hier: <a href="media/E_table.pdf" target="_blank" rel="noopener noreferrer">E-tabel (PDF)</a>
