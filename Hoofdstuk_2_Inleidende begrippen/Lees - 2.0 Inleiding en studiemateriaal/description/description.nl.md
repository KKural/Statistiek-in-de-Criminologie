...
![Beslisboom](https://example.com/images/meetniveau-beslisboom.png)
...
|----------|---------------|------------------|
| **Nominaal** | Categorieën zonder ordening | Geslacht, nationaliteit, delicttype |
| **Ordinaal** | Categorieën met ordening | Opleidingsniveau, tevredenheidsscore |
| **Interval** | Getallen, geen echt nulpunt | Temperatuur (°C), IQ-scores |
| **Ratio** | Getallen met echt nulpunt | Leeftijd, inkomen, aantal delicten |

---

## 🎮 **Interactieve Oefentools**
...
## 📋 **Checklist: Ben je klaar voor de oefeningen?**

☑️ **Ik heb alle 4 video's bekeken**  
☑️ **Ik heb hoofdstuk 2 van het handboek gelezen**  
☑️ **Ik heb de aanvullende artikelen bestudeerd**  
☑️ **Ik heb de cheatsheet gedownload**  
☑️ **Ik heb de online quiz gemaakt (minimaal 80% score)**  
☑️ **Ik begrijp het verschil tussen alle meetniveaus**  
☑️ **Ik kan onderzoeksvraagtypen onderscheiden**  

---

## 🚀 **Volgende Stappen**

Als je alle materialen hebt bestudeerd en de checklist hebt afgewerkt, ben je klaar voor:

1. **Oef - 2.1:** Meetniveau - Delicten rangschikken
2. **Oef - 2.2:** Meetniveau - Empathieschaal
3. **...** en alle verdere oefeningen!

---

## 💡 **Tips voor Succes**

🔸 **Bestudeer de materialen in volgorde** - elk onderdeel bouwt voort op het vorige  
🔸 **Maak aantekeningen** - schrijf belangrijke concepten op  
🔸 **Test jezelf regelmatig** - gebruik de online tools  
🔸 **Vraag om hulp** - als iets onduidelijk is, stel vragen  
🔸 **Oefen met voorbeelden** - zoek zelf criminologie voorbeelden  
...
📧 Email: [docent@ugent.be](mailto:docent@ugent.be)  
🕐 Spreekuur: Dinsdag 14:00-16:00

**Technische problemen?**  
📧 Email: [support@dodona.be](mailto:support@dodona.be)

---

**⚠️ Belangrijk:** Deze studiematerialen zijn verplicht voor alle studenten. Zonder grondige voorbereiding worden de praktische oefeningen aanzienlijk moeilijker.
