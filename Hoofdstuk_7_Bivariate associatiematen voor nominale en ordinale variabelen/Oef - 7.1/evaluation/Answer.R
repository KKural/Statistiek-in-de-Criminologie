        ...
        comparator = function(generated, expected, ...) {
          ...
          wrong_msg_chi2 <- function(val) {
            ...
            return(paste0(
              ...
              "2. **Celbijdragen:**\n",
              "   - (380-307.5)²/307.5 = 17.09\n",
              "   - (850-922.5)²/922.5 = 5.70\n",
              "   - (120-192.5)²/192.5 = 27.27\n",
              "   - (650-577.5)²/577.5 = 9.10 ✓\n",
              "3. **χ²:** 17.09 + 5.70 + 27.27 + 9.10 = **56.34** (afgerond op 4 dec: 56.3423) ✓"
            ))
          }
          ...
          feedback_text <- paste0(
            ...
            "- **χ²:** 56.34 (df=1, p<0.001 → significant verband)\n",
