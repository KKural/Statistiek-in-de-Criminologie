      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "2" = "✅ Juist - de **motivatieschaal** van 1 tot 5 bevindt zich op het ordinaal meetniveau. De cijfers geven een rangorde aan van motivatie: een 5 betekent meer motivatie dan een 3. Echter, de afstand tussen de cijfers is niet noodzakelijk gelijk. Het verschil in motivatie tussen een 1 en een 2 kan subjectief anders worden ervaren dan tussen een 4 en een 5. [Lees meer](https://www.youtube.com/watch?v=KJPXZIEmvfA)",
            
            "3" = "❌ Fout - **Interval** heeft numerieke waarden met gelijke afstanden, maar geen absoluut nulpunt. Criminologische voorbeelden: IQ-test scores, jaar van geboorte. Bij motivatieschalen is de 'afstand' tussen 1 en 2 niet noodzakelijk gelijk aan die tussen 4 en 5 - het zijn subjectieve beoordelingen. [Lees meer](https://www.youtube.com/watch?v=KJPXZIEmvfA),"
