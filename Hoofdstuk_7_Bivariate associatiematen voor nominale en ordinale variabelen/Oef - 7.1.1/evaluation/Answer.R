        ...
        comparator = function(generated, expected, ...) {
          ...
          wrong_msg <- function(key) {
            ...
            if (key == "perc_yes_male") {
              ...
              if (approx_eq(v, (cst$male_yes / cst$n_yes * 100), tol = 0.2)) return("Je gebruikte het rijtotaal (totaal JA) als noemer. Voor kolompercentages deel je door het kolomtotaal (totaal mannen).")
            ...
            if (key == "perc_yes_female") {
              ...
              if (approx_eq(v, (cst$female_yes / cst$n_yes * 100), tol = 0.2)) return("Je gebruikte het rijtotaal (totaal JA) als noemer. Voor kolompercentages deel je door het kolomtotaal (totaal vrouwen).")
            ...
            if (key == "perc_diff") {
              ...
              if (abs(v + results[[key]]$expected) < 0.2) return("Je nam het verschil in omgekeerde richting. Neem (mannen% - vrouwen%).")
            ...
            if (key == "chi2") {
              ...
              if (approx_eq(v, sqrt(results[[key]]$expected / cst$total), tol = 0.03)) return("Je gaf phi (sqrt(chi^2/N)) i.p.v. chi^2.")
