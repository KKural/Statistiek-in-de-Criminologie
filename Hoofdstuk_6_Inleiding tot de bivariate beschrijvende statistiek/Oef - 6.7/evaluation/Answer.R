      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "2" = "✅ Juist! Je houdt rekening met het **meetniveau** van de variabelen én of de associatie theoretisch **symmetrisch of asymmetrisch** is. <a href='https://www.statisticssolutions.com/free-resources/directory-of-statistical-analyses/measures-of-association/' target='_blank' rel='noopener noreferrer'>Lees meer over associatiematen</a>",
            ...
            "4" = "❌ Fout. De keuze van assen is een visualisatiekeuze, niet de basisregel voor associatiematen. <a href='https://www.statisticssolutions.com/free-resources/directory-of-statistical-analyses/measures-of-association/' target='_blank' rel='noopener noreferrer'>Lees meer over grafieken</a>"
          )
