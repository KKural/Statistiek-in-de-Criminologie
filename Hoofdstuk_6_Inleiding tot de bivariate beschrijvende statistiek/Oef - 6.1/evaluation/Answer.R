    ...
    " ",
    {
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            "1" = "❌ Fout. Statistische samenhang is **niet** voldoende om causaliteit te bewijzen. Statistiek toont enkel verbanden; de oorzakelijke interpretatie komt uit theorie, kennis van mechanismen en onderzoeksdesign. <a href='https://www.scribbr.com/methodology/correlation-vs-causation/' target='_blank' rel='noopener noreferrer'>Lees meer over correlatie en causaliteit</a>",
            ...
            "4" = "❌ Fout. Causaliteit is een theoretisch/filosofisch begrip, terwijl statistische relaties enkel de **empirische samenhang** beschrijven. Twee variabelen kunnen correleren zonder dat er een oorzakelijk verband is (schijnverband). <a href='https://www.scribbr.com/methodology/confounding-variables/' target='_blank' rel='noopener noreferrer'>Lees meer over confounding</a>"
          )
