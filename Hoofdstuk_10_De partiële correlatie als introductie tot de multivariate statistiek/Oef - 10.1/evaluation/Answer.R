    ...
    "",
    {
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          ...
          likely_conclusion <- c(
            "Je ziet mogelijk de daling en noemt het verband volledig schijn, hoewel de partiële correlatie betekenisvol van nul blijft verschillen.",
            "correct",
            "Je noemt mogelijk elke verandering na controle suppressie, hoewel de absolute correlatie hier juist afneemt.",
            "Je verwacht mogelijk een tekenwisseling en kijkt onvoldoende naar het feit dat beide correlaties hetzelfde teken houden."
          )
