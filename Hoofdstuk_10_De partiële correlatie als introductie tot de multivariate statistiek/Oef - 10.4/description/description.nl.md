...
- 1 = Schijnverband (r_XY.Z ≈ 0 na controle)
- 2 = Indirect verband (r_XY.Z is kleiner maar blijft bestaan)
- 3 = Suppressoreffect (r_XY.Z is sterker of heeft ander teken na controle)
- 4 = Reëel verband (r_XY.Z nauwelijks veranderd)
...
Resultaten:
- r_XY = **0.62** (bivariaat)
- r_XY.Z = **0.07** (na controle voor SES van de wijk)
...
Een criminoloog onderzoekt bij 95 jongvolwassenen de relatie tussen **alcoholgebruik** (X) en **agressief gedrag** (Y). Er wordt gecontroleerd voor **stress** (Z).

Resultaten:
- r_XY = **0.38** (bivariaat)
- r_XY.Z = **0.21** (na controle voor stress)
...
Een studie bij 200 gevangenen onderzoekt de relatie tussen **deelname aan rehabilitatieprogramma's** (X) en **recidive** (Y). Er wordt gecontroleerd voor **motivatie** (Z).

Resultaten:
- r_XY = **-0.12** (bivariaat, zwak negatief)
- r_XY.Z = **-0.53** (na controle voor motivatie, sterk negatief)
