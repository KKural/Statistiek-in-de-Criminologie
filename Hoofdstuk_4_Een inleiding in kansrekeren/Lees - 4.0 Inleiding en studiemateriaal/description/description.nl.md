...
1. **Wat is de gebeurtenis?** Schrijf bijvoorbeeld `A ∪ B`, `A ∩ B` of `B | A`.
2. **Kunnen de gebeurtenissen samen voorkomen?** Zo niet, dan zijn ze disjunct.
3. **Verandert kennis van A de kans op B?** Zo niet, dan zijn ze onafhankelijk.
